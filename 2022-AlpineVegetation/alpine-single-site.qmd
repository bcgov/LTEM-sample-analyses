...
#
# 2022-12-06 Updated to quatro; more data available for one site
...
title: "`r paste0('Alpine Vegetation - LTEM - ',params$STUDY_AREA_NAME)`" 
date: today
...
data.extract <- read.LTEM.data(study.type="Alpine",

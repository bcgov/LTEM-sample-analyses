...
* It doesn/t eem to be possible to distinguish between auditory and visual surveys based on information in the data base other than by looking at the transect name. 
This will not work if the transect name is a general name. 
* Detection data on either type of transect includes both visual and auditory detections (see the A0/A2 column under the 1.3 and 1.4 protocols.)
The auditory detections on a visual transect should be deleted and vice-versa.

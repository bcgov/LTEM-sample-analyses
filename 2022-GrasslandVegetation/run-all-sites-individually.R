# This script will run ALL of the sites in the Grasslands protocol
...
all.data <- read.LTEM.data(study.type="Grasslands")
...
projects <- projects[ projects$SPI_PROJECT_ID %in% PROJECT_CODE.Grasslands,]
...
plyr::l_ply(sort(unique(projects$"STUDY_AREA_NAME"))[], function(x){
  ...
  quarto::quarto_render("grass-single-site.qmd",

# This script will run ALL of the sites in the berry protocol
...
all.data <- read.LTEM.data(study.type="Berries")
...
projects <- projects[ projects$SPI_PROJECT_ID %in% PROJECT_CODE.Berries,]
...
plyr::l_ply(sort(unique(projects$"STUDY_AREA_NAME"))[], function(x){
  ...
  quarto::quarto_render("berry-single-site.qmd",

# This script will run ALL of the sites in the squirrel protocol
...
all.data <- read.LTEM.data(study.type="Squirrels")
...
projects <- projects[ projects$SPI_PROJECT_ID %in% PROJECT_CODE.Squirrels,]
...
plyr::l_ply(sort(unique(projects$"STUDY_AREA_NAME"))[], function(x){
  ...
  quarto::quarto_render("squirrel-single-site.qmd",

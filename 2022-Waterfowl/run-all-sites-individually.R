# This script will run ALL of the sites in the waterfowl protocol
...
# We need to get ALL of the raw data to identify which study areas have waterfowl measurements
all.data <- read.LTEM.data(study.type="Waterfowl")
...
projects <- projects[ projects$SPI_PROJECT_ID %in% PROJECT_CODE.Waterfowl,]
...
plyr::l_ply(sort(unique(projects$"STUDY_AREA_NAME"))[], function(x){
  ...
  quarto::quarto_render("waterfowl-single-site.qmd",
